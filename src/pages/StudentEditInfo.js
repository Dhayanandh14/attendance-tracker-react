...
const Editinfo = (props) => {
  ...
  const saveInfo = () => {
    let updateStudentInfo = {
      ...
      user_name: studentInfoFormValues.name,
      user_email: studentInfoFormValues.email,
      access_id: studentInfoFormValues.access_id,
      role: "student",
      age: studentInfoFormValues.age,
      phone_number: studentInfoFormValues.contact_number,
      personal_email: studentInfoFormValues.personal_email,
      squad_name: studentInfoFormValues.squad_name,
      date_of_Join: studentInfoFormValues.date_of_Join,
      education: studentInfoFormValues.education,
      aadhar_number: studentInfoFormValues.aadhar_number,
      home_address: studentInfoFormValues.home_address,
      communication_address: studentInfoFormValues.communication_address,
      interviewer: studentInfoFormValues.interviewer,
      interviewer_review: studentInfoFormValues.interviewer_review,
      emergency_contact_name: studentInfoFormValues.emergency_contact_name,
      emergency_contact_number: studentInfoFormValues.emergency_contact_number,
      gender: studentInfoFormValues.gender,
      blood_group: studentInfoFormValues.blood_group,
      status: studentInfoFormValues.status,
