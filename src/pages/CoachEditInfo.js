...
const CoachEditInfo = (props) => {
  ...
  const saveInfo = () => {
    let updateCoachInfo = {
      user_id: coachInfoFormValues.userId,
      coach_id: coachInfoFormValues.coachId,
      user_name: coachInfoFormValues.name,
      user_email: coachInfoFormValues.email,
      access_id: coachInfoFormValues.access_id,
      role: "coach",
      age: coachInfoFormValues.age,
      phone_number: coachInfoFormValues.contact_number,
      personal_email: coachInfoFormValues.personal_email,
      status: coachInfoFormValues.status,
      aadhar_number: coachInfoFormValues.aadhar_number,
      home_address: coachInfoFormValues.home_address,
      communication_address: coachInfoFormValues.communication_address,
      emergency_contact_name: coachInfoFormValues.emergency_contact_name,
      emergency_contact_number: coachInfoFormValues.emergency_contact_number,
      gender: coachInfoFormValues.gender,
      blood_group: coachInfoFormValues.blood_group,
